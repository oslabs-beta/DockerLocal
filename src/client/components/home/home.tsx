  ...
  useEffect(() => {
    ...
    const fetched = [
      {projectName: 'DockerLocal(project1)', projectId: 1, projectRepos: [
        {repoName: 'perrepop1', repoCloneLink: 'personallink1', isIncluded: false},
        {repoName: 'abcdefgpersonal2', repoCloneLink: 'personallink2', isIncluded: false},
        {repoName: 'abbsddpersonalRepo3', repoCloneLink: 'personallink3', isIncluded: false},
      ...
      {projectName: 'React Visualizer 2.5(project2)', projectId: 2, projectRepos: [        {repoName: 'collab Repo4', repoCloneLink: 'collablink4', isIncluded: false},
      {repoName: 'collab Repo5', repoCloneLink: 'collablink5', isIncluded: false},
      {repoName: 'collab Repo6', repoCloneLink: 'collablink6', isIncluded: false},
]},
      {projectName: 'React Visualizer 8.5(project3)', projectId: 3, projectRepos: [        {repoName: 'organization Repo5', repoCloneLink: 'orglink5', isIncluded: false},
      ...
      {projectName: 'React Visualizer 77.0(project4)', projectId: 4, projectRepos: [        {repoName: 'organization Repo5', repoCloneLink: 'orglink5', isIncluded: false},
      {repoName: 'organization Repo6', repoCloneLink: 'orglink6', isIncluded: false},
      {repoName: 'collab Repo1', repoCloneLink: 'collablink1', isIncluded: false},
      {repoName: 'collab Repo2', repoCloneLink: 'collablink2', isIncluded: false},
]},
      {projectName: 'React Visualizer 85.0(project5)', projectId: 5, projectRepos: [        {repoName: 'organization Repo4', repoCloneLink: 'orglink4', isIncluded: false},
      {repoName: 'collab Repo3', repoCloneLink: 'collablink3', isIncluded: false},
]},
    ];
